...
$string['testoutgoingtextconf_fromtext'] = 'From username or email address';
$string['testoutgoingtextconf_fromtext_help'] = 'This field emulates sending the message from that user, but the From header used in the real email sent will depend on other settings such as allowedemaildomains';
$string['testoutgoingtextconf_fromtext_invalid'] = 'Invalid From username or email. Must be a valid email format or an existing username in Moodle.';
...
$string['testoutgoingtextconf_totext'] = 'To email address';
